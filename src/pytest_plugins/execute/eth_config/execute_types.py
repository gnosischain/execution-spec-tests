...
class GenesisConfig(CamelModel):
    ...
    deposit_contract_address: Address = Address(0xBABE2BED00000000000000000000000000000003)
    fork_activation_times: ForkActivationTimes
    ...
    def address_overrides(self) -> AddressOverrideDict:
        ...
        if self.deposit_contract_address == Address(0xBABE2BED00000000000000000000000000000003):
            return AddressOverrideDict({})
        return AddressOverrideDict(
            {Address(0xBABE2BED00000000000000000000000000000003): self.deposit_contract_address}
        )
