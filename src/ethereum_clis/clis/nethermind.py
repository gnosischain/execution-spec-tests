...
class NethermindTransitionTool(TransitionTool):
    """Nethermind `evm` Transition tool interface wrapper class."""
    ...
    def is_verifiable(
        ...
        """Return whether the fixture format is verifiable by this Nethermind's evm tool."""
...
class NethermindExceptionMapper(ExceptionMapper):
    """Translate between EEST exceptions and error strings returned by Nethermind."""
    ...
    def _mapping_data(self):
        return [
            ...
            ExceptionMessage(
                ...
                "InvalidTxType: Transaction type in Shanghai is not supported.",
            ),
            ExceptionMessage(
