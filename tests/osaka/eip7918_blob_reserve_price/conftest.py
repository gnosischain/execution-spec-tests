...
def block_base_fee_per_gas(
    ...
    if parent_excess_blobs is None:
        ...
        blob_base_fee = blob_gas_price_calculator(excess_blob_gas=parent_excess_blob_gas)
...
def reserve_price(
    ...
    return Spec.get_reserve_price(fork=fork, base_fee_per_gas=block_base_fee_per_gas)
