...
class Spec(EIP4844Spec):
    ...
    def get_reserve_price(
        ...
        *,
        ...
        return (cls.BLOB_BASE_COST * base_fee_per_gas) // fork.blob_gas_per_blob()
    ...
    def is_reserve_price_active(
        ...
        *,
        ...
        return cls.BLOB_BASE_COST * base_fee_per_gas > blob_base_fee * fork.blob_gas_per_blob()
    ...
    def calc_effective_blob_base_fee(
        ...
        *,
        ...
        """
        reserve_price = cls.get_reserve_price(fork=fork, base_fee_per_gas=base_fee_per_gas)
